...
@XmlType(name = "reservaItem", namespace = "http://aqpgo.com/reservas")
...
public class ReservaItem {
    ...
    public List<AcompananteItem> getAcompanante() { return acompanante; }
    public void setAcompanante(List<AcompananteItem> acompanante) { this.acompanante = acompanante; }
}